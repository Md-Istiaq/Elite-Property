...
const FAQ = () => {
    return (
        <div className='bg-stone-800 sm:h-[800px] lg:h-[400px] md:h-[400px] m-10'>
            ...
            <h1 className='text-3xl text-green-400 m-10 text-center'>FAQ's- Frequently asked question</h1>
            ...
            <label tabindex="0" class="text-xl hover:text-green-400 border border-green-400 p-5  m-1 rounded-xl">How can i build Equity in my house  ↓</label>
            ...
            <label tabindex="0" class="text-xl hover:text-green-400 border border-green-400 p-5  m-1 rounded-xl">What's loan commitment letter? ↓</label>
            <div tabindex="0" class="dropdown-content card card-compact w-64 p-2 shadow bg-primary text-primary-content">
            <div class="card-body">
            ...
            <div class="dropdown align-center sm:h-[50px]">
            <label tabindex="0" class="text-xl hover:text-green-400 border border-green-400 p-5  m-1 rounded-xl">What dose DOM mean in the MLS? ↓</label>
            <div tabindex="0" class="dropdown-content card card-compact w-64 p-2 shadow bg-primary text-primary-content">
            <div class="card-body">
